...
async def migrate_and_delete_ls_v2():
    ...
    print(f"Migrating data from {source_id} to {target_id} (V2)...")
    
    async with conn.transaction():
        # 1. source의 데이터를 변수에 저장
        ...
        # 2. source(231728318) 먼저 삭제 (Unique KEY 제약 해제)
...
if __name__ == "__main__":
    asyncio.run(migrate_and_delete_ls_v2())
